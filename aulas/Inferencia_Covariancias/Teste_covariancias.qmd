...
Para esse fim, ele fez oito medidas morfológicas em cada pássaro, e também os pesou. Os resultados de cinco das medidas são disponibilizados na base de dados [Bumpus_sparrows](/dados/Bumpus_sparrows.csv), para fêmeas somente.
...
A estatística do teste $M$ de Box é dad por
